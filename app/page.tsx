    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">HDCS is a family owned and operated business that has been serving the High Desert since the 1980s.
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                title: "Fire Safety",
                description: "Keep your family safe from chimney fires and other hazards.",
                icon: "🔥"
              },
              {
                title: "Expert Team",
              ...
              {
                title: "Efficient Burn",
                description: "A clean chimney promotes efficient burn, reduces smoke, and saves on wood.",
                icon: "🪵"
              }
            ].map((feature, index) => (
      ...
      <section className="py-20 bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">Ready to </h2>
